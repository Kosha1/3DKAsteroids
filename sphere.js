...
// The minimum # of sectors is 2 and stacks is 2.
//
...
function Sphere(gl, radius=1, sectors=36, stacks=18, smooth=true)
{
    this.gl = gl;
    if(!gl)
        log("[WARNING] Sphere.constructor requires GL context as a param.");
